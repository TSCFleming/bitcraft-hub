...
error: String,
    ...
    fn on_save_inter_module_message_error(&self, callback: impl FnMut(&super::ReducerEventContext, &u8, &u64, &String, ) + Send + 'static) -> SaveInterModuleMessageErrorCallbackId;
    /// Cancel a callback previously registered by [`Self::on_save_inter_module_message_error`],
    /// causing it not to run in the future.
    fn remove_on_save_inter_module_message_error(&self, callback: SaveInterModuleMessageErrorCallbackId);
}
...
error: String,
        ...
        self.imp.call_reducer("save_inter_module_message_error", SaveInterModuleMessageErrorArgs { sender, message_id, error,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::SaveInterModuleMessageError {
                            sender, message_id, error, 
                        },
                        ..
                    },
                    ..
    ...
    fn remove_on_save_inter_module_message_error(&self, callback: SaveInterModuleMessageErrorCallbackId) {
        self.imp.remove_on_reducer("save_inter_module_message_error", callback.0)
    }
}
...
impl set_flags_for_save_inter_module_message_error for super::SetReducerFlags {
    fn save_inter_module_message_error(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("save_inter_module_message_error", flags);
    }
}
