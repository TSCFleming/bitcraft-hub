...
ability: AbilityType,
    ...
    fn on_ability_set(&self, callback: impl FnMut(&super::ReducerEventContext, &u8, &u8, &AbilityType, ) + Send + 'static) -> AbilitySetCallbackId;
...
ability: AbilityType,
        ...
        self.imp.call_reducer("ability_set", AbilitySetArgs { action_bar_index, local_ability_index, ability,  })
    }
    fn on_ability_set(
        &self,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AbilitySet {
                            action_bar_index, local_ability_index, ability, 
                        },
                        ..
                    },
                    ..
