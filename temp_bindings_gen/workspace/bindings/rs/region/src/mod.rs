...
pub use ability_custom_activate_reducer::{ability_custom_activate, set_flags_for_ability_custom_activate, AbilityCustomActivateCallbackId};
pub use ability_custom_activate_start_reducer::{ability_custom_activate_start, set_flags_for_ability_custom_activate_start, AbilityCustomActivateStartCallbackId};
pub use ability_remove_reducer::{ability_remove, set_flags_for_ability_remove, AbilityRemoveCallbackId};
...
pub use activate_building_buff_reducer::{activate_building_buff, set_flags_for_activate_building_buff, ActivateBuildingBuffCallbackId};
pub use admin_add_specific_building_type_states_reducer::{admin_add_specific_building_type_states, set_flags_for_admin_add_specific_building_type_states, AdminAddSpecificBuildingTypeStatesCallbackId};
...
pub use admin_create_building_spawns_reducer::{admin_create_building_spawns, set_flags_for_admin_create_building_spawns, AdminCreateBuildingSpawnsCallbackId};
...
pub use admin_create_entity_name_report_reducer::{admin_create_entity_name_report, set_flags_for_admin_create_entity_name_report, AdminCreateEntityNameReportCallbackId};
...
pub use admin_dungeon_update_portals_reducer::{admin_dungeon_update_portals, set_flags_for_admin_dungeon_update_portals, AdminDungeonUpdatePortalsCallbackId};
pub use admin_fail_quest_reducer::{admin_fail_quest, set_flags_for_admin_fail_quest, AdminFailQuestCallbackId};
...
pub use admin_grant_all_claim_supplies_reducer::{admin_grant_all_claim_supplies, set_flags_for_admin_grant_all_claim_supplies, AdminGrantAllClaimSuppliesCallbackId};
...
pub use admin_migrate_action_state_reducer::{admin_migrate_action_state, set_flags_for_admin_migrate_action_state, AdminMigrateActionStateCallbackId};
pub use admin_migrate_trade_orders_reducer::{admin_migrate_trade_orders, set_flags_for_admin_migrate_trade_orders, AdminMigrateTradeOrdersCallbackId};
...
pub use admin_patch_housing_costs_reducer::{admin_patch_housing_costs, set_flags_for_admin_patch_housing_costs, AdminPatchHousingCostsCallbackId};
...
pub use admin_restore_all_buildings_health_reducer::{admin_restore_all_buildings_health, set_flags_for_admin_restore_all_buildings_health, AdminRestoreAllBuildingsHealthCallbackId};
...
pub use admin_set_region_control_state_reducer::{admin_set_region_control_state, set_flags_for_admin_set_region_control_state, AdminSetRegionControlStateCallbackId};
pub use admin_set_resource_world_target_reducer::{admin_set_resource_world_target, set_flags_for_admin_set_resource_world_target, AdminSetResourceWorldTargetCallbackId};
...
pub use admin_unlock_house_reducer::{admin_unlock_house, set_flags_for_admin_unlock_house, AdminUnlockHouseCallbackId};
...
pub use admin_update_region_moderation_config_reducer::{admin_update_region_moderation_config, set_flags_for_admin_update_region_moderation_config, AdminUpdateRegionModerationConfigCallbackId};
pub use advance_quest_stage_reducer::{advance_quest_stage, set_flags_for_advance_quest_stage, AdvanceQuestStageCallbackId};
...
pub use attack_impact_migrated_reducer::{attack_impact_migrated, set_flags_for_attack_impact_migrated, AttackImpactMigratedCallbackId};
...
pub use cheat_claim_delete_walls_reducer::{cheat_claim_delete_walls, set_flags_for_cheat_claim_delete_walls, CheatClaimDeleteWallsCallbackId};
...
pub use cheat_claim_unlock_tech_reducer::{cheat_claim_unlock_tech, set_flags_for_cheat_claim_unlock_tech, CheatClaimUnlockTechCallbackId};
pub use cheat_claims_complete_all_current_research_reducer::{cheat_claims_complete_all_current_research, set_flags_for_cheat_claims_complete_all_current_research, CheatClaimsCompleteAllCurrentResearchCallbackId};
...
pub use cheat_drop_item_on_entity_reducer::{cheat_drop_item_on_entity, set_flags_for_cheat_drop_item_on_entity, CheatDropItemOnEntityCallbackId};
pub use cheat_drop_item_on_tile_reducer::{cheat_drop_item_on_tile, set_flags_for_cheat_drop_item_on_tile, CheatDropItemOnTileCallbackId};
...
pub use cheat_quest_advance_to_handin_reducer::{cheat_quest_advance_to_handin, set_flags_for_cheat_quest_advance_to_handin, CheatQuestAdvanceToHandinCallbackId};
pub use cheat_quest_clear_reducer::{cheat_quest_clear, set_flags_for_cheat_quest_clear, CheatQuestClearCallbackId};
pub use cheat_quest_restart_reducer::{cheat_quest_restart, set_flags_for_cheat_quest_restart, CheatQuestRestartCallbackId};
pub use cheat_quest_skip_reducer::{cheat_quest_skip, set_flags_for_cheat_quest_skip, CheatQuestSkipCallbackId};
pub use cheat_quest_skip_stage_reducer::{cheat_quest_skip_stage, set_flags_for_cheat_quest_skip_stage, CheatQuestSkipStageCallbackId};
...
pub use cheat_undiscover_map_reducer::{cheat_undiscover_map, set_flags_for_cheat_undiscover_map, CheatUndiscoverMapCallbackId};
...
pub use claim_set_protection_threshold_reducer::{claim_set_protection_threshold, set_flags_for_claim_set_protection_threshold, ClaimSetProtectionThresholdCallbackId};
...
pub use complete_quest_chain_reducer::{complete_quest_chain, set_flags_for_complete_quest_chain, CompleteQuestChainCallbackId};
...
pub use crumb_tail_cleanup_agent_insert_reducer::{crumb_tail_cleanup_agent_insert, set_flags_for_crumb_tail_cleanup_agent_insert, CrumbTailCleanupAgentInsertCallbackId};
pub use crumb_tail_cleanup_agent_loop_reducer::{crumb_tail_cleanup_agent_loop, set_flags_for_crumb_tail_cleanup_agent_loop, CrumbTailCleanupAgentLoopCallbackId};
...
pub use delete_developer_identity_reducer::{delete_developer_identity, set_flags_for_delete_developer_identity, DeleteDeveloperIdentityCallbackId};
...
pub use deployable_dismount_server_reducer::{deployable_dismount_server, set_flags_for_deployable_dismount_server, DeployableDismountServerCallbackId};
pub use deployable_follow_reducer::{deployable_follow, set_flags_for_deployable_follow, DeployableFollowCallbackId};
...
pub use deployable_store_from_collectible_id_reducer::{deployable_store_from_collectible_id, set_flags_for_deployable_store_from_collectible_id, DeployableStoreFromCollectibleIdCallbackId};
...
pub use deployable_toggle_auto_follow_reducer::{deployable_toggle_auto_follow, set_flags_for_deployable_toggle_auto_follow, DeployableToggleAutoFollowCallbackId};
...
pub use empire_create_reducer::{empire_create, set_flags_for_empire_create, EmpireCreateCallbackId};
...
pub use empire_donate_item_reducer::{empire_donate_item, set_flags_for_empire_donate_item, EmpireDonateItemCallbackId};
...
pub use import_ability_custom_desc_reducer::{import_ability_custom_desc, set_flags_for_import_ability_custom_desc, ImportAbilityCustomDescCallbackId};
pub use import_ability_unlock_desc_reducer::{import_ability_unlock_desc, set_flags_for_import_ability_unlock_desc, ImportAbilityUnlockDescCallbackId};
...
pub use import_building_buff_desc_reducer::{import_building_buff_desc, set_flags_for_import_building_buff_desc, ImportBuildingBuffDescCallbackId};
...
pub use import_combat_action_multi_hit_desc_reducer::{import_combat_action_multi_hit_desc, set_flags_for_import_combat_action_multi_hit_desc, ImportCombatActionMultiHitDescCallbackId};
...
pub use import_contribution_loot_desc_reducer::{import_contribution_loot_desc, set_flags_for_import_contribution_loot_desc, ImportContributionLootDescCallbackId};
...
pub use import_enemy_scaling_desc_reducer::{import_enemy_scaling_desc, set_flags_for_import_enemy_scaling_desc, ImportEnemyScalingDescCallbackId};
...
pub use import_premium_item_desc_reducer::{import_premium_item_desc, set_flags_for_import_premium_item_desc, ImportPremiumItemDescCallbackId};
pub use import_premium_service_desc_reducer::{import_premium_service_desc, set_flags_for_import_premium_service_desc, ImportPremiumServiceDescCallbackId};
...
pub use import_prospecting_desc_reducer::{import_prospecting_desc, set_flags_for_import_prospecting_desc, ImportProspectingDescCallbackId};
pub use import_quest_chain_desc_reducer::{import_quest_chain_desc, set_flags_for_import_quest_chain_desc, ImportQuestChainDescCallbackId};
pub use import_quest_stage_desc_reducer::{import_quest_stage_desc, set_flags_for_import_quest_stage_desc, ImportQuestStageDescCallbackId};
...
pub use import_stage_rewards_desc_reducer::{import_stage_rewards_desc, set_flags_for_import_stage_rewards_desc, ImportStageRewardsDescCallbackId};
...
pub use import_wind_params_desc_reducer::{import_wind_params_desc, set_flags_for_import_wind_params_desc, ImportWindParamsDescCallbackId};
...
pub use init_region_info_reducer::{init_region_info, set_flags_for_init_region_info, InitRegionInfoCallbackId};
...
pub use migrate_auto_attacks_reducer::{migrate_auto_attacks, set_flags_for_migrate_auto_attacks, MigrateAutoAttacksCallbackId};
pub use migrate_character_stats_reducer::{migrate_character_stats, set_flags_for_migrate_character_stats, MigrateCharacterStatsCallbackId};
pub use migrate_claim_tech_reducer::{migrate_claim_tech, set_flags_for_migrate_claim_tech, MigrateClaimTechCallbackId};
pub use migrate_grant_default_collectibles_reducer::{migrate_grant_default_collectibles, set_flags_for_migrate_grant_default_collectibles, MigrateGrantDefaultCollectiblesCallbackId};
pub use migrate_onboarding_reducer::{migrate_onboarding, set_flags_for_migrate_onboarding, MigrateOnboardingCallbackId};
pub use migrate_player_settings_reducer::{migrate_player_settings, set_flags_for_migrate_player_settings, MigratePlayerSettingsCallbackId};
pub use migration_set_achievement_params_reducer::{migration_set_achievement_params, set_flags_for_migration_set_achievement_params, MigrationSetAchievementParamsCallbackId};
pub use migration_set_building_desc_params_reducer::{migration_set_building_desc_params, set_flags_for_migration_set_building_desc_params, MigrationSetBuildingDescParamsCallbackId};
...
pub use player_settings_state_update_reducer::{player_settings_state_update, set_flags_for_player_settings_state_update, PlayerSettingsStateUpdateCallbackId};
...
pub use prospect_start_reducer::{prospect_start, set_flags_for_prospect_start, ProspectStartCallbackId};
...
pub use report_entity_reducer::{report_entity, set_flags_for_report_entity, ReportEntityCallbackId};
pub use report_player_reducer::{report_player, set_flags_for_report_player, ReportPlayerCallbackId};
pub use request_stage_reward_reducer::{request_stage_reward, set_flags_for_request_stage_reward, RequestStageRewardCallbackId};
...
pub use save_inter_module_message_error_reducer::{save_inter_module_message_error, set_flags_for_save_inter_module_message_error, SaveInterModuleMessageErrorCallbackId};
...
pub use set_quest_tracked_reducer::{set_quest_tracked, set_flags_for_set_quest_tracked, SetQuestTrackedCallbackId};
...
pub use skip_onboarding_reducer::{skip_onboarding, set_flags_for_skip_onboarding, SkipOnboardingCallbackId};
pub use sleep_reducer::{sleep, set_flags_for_sleep, SleepCallbackId};
pub use stage_ability_custom_desc_reducer::{stage_ability_custom_desc, set_flags_for_stage_ability_custom_desc, StageAbilityCustomDescCallbackId};
pub use stage_ability_unlock_desc_reducer::{stage_ability_unlock_desc, set_flags_for_stage_ability_unlock_desc, StageAbilityUnlockDescCallbackId};
...
pub use stage_building_buff_desc_reducer::{stage_building_buff_desc, set_flags_for_stage_building_buff_desc, StageBuildingBuffDescCallbackId};
...
pub use stage_combat_action_multi_hit_desc_reducer::{stage_combat_action_multi_hit_desc, set_flags_for_stage_combat_action_multi_hit_desc, StageCombatActionMultiHitDescCallbackId};
...
pub use stage_contribution_loot_desc_reducer::{stage_contribution_loot_desc, set_flags_for_stage_contribution_loot_desc, StageContributionLootDescCallbackId};
...
pub use stage_enemy_scaling_desc_reducer::{stage_enemy_scaling_desc, set_flags_for_stage_enemy_scaling_desc, StageEnemyScalingDescCallbackId};
...
pub use stage_premium_item_desc_reducer::{stage_premium_item_desc, set_flags_for_stage_premium_item_desc, StagePremiumItemDescCallbackId};
pub use stage_premium_service_desc_reducer::{stage_premium_service_desc, set_flags_for_stage_premium_service_desc, StagePremiumServiceDescCallbackId};
...
pub use stage_prospecting_desc_reducer::{stage_prospecting_desc, set_flags_for_stage_prospecting_desc, StageProspectingDescCallbackId};
pub use stage_quest_chain_desc_reducer::{stage_quest_chain_desc, set_flags_for_stage_quest_chain_desc, StageQuestChainDescCallbackId};
pub use stage_quest_stage_desc_reducer::{stage_quest_stage_desc, set_flags_for_stage_quest_stage_desc, StageQuestStageDescCallbackId};
...
pub use stage_stage_rewards_desc_reducer::{stage_stage_rewards_desc, set_flags_for_stage_stage_rewards_desc, StageStageRewardsDescCallbackId};
...
pub use stage_wind_params_desc_reducer::{stage_wind_params_desc, set_flags_for_stage_wind_params_desc, StageWindParamsDescCallbackId};
...
pub use start_quest_chain_reducer::{start_quest_chain, set_flags_for_start_quest_chain, StartQuestChainCallbackId};
...
pub use storage_log_cleanup_loop_reducer::{storage_log_cleanup_loop, set_flags_for_storage_log_cleanup_loop, StorageLogCleanupLoopCallbackId};
...
pub use update_moving_cost_reducer::{update_moving_cost, set_flags_for_update_moving_cost, UpdateMovingCostCallbackId};
...
pub use world_clear_npc_watchtowers_reducer::{world_clear_npc_watchtowers, set_flags_for_world_clear_npc_watchtowers, WorldClearNpcWatchtowersCallbackId};
pub use world_place_building_reducer::{world_place_building, set_flags_for_world_place_building, WorldPlaceBuildingCallbackId};
pub use world_place_npc_watchtowers_reducer::{world_place_npc_watchtowers, set_flags_for_world_place_npc_watchtowers, WorldPlaceNpcWatchtowersCallbackId};
pub use world_place_resource_reducer::{world_place_resource, set_flags_for_world_place_resource, WorldPlaceResourceCallbackId};
...
pub struct DbUpdate {
    ...
    claim_local_supply_security_threshold_state: __sdk::TableUpdate<ClaimLocalSupplySecurityThresholdState>,
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(&self, cache: &mut __sdk::ClientCache<RemoteModule>) -> AppliedDiff<'_> {
        ...
        diff.active_environment_buff_state = cache.apply_diff_to_table::<ActiveEnvironmentBuffState>("active_environment_buff_state", &self.active_environment_buff_state);
        ...
        diff.construction_recipe_discovery_cargo_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("construction_recipe_discovery_cargo_desc", &self.construction_recipe_discovery_cargo_desc);
        diff.construction_recipe_discovery_item_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("construction_recipe_discovery_item_desc", &self.construction_recipe_discovery_item_desc);
        diff.construction_recipe_discovery_knowledge_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("construction_recipe_discovery_knowledge_desc", &self.construction_recipe_discovery_knowledge_desc);
        ...
        diff.crafting_recipe_discovery_cargo_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("crafting_recipe_discovery_cargo_desc", &self.crafting_recipe_discovery_cargo_desc);
        diff.crafting_recipe_discovery_item_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("crafting_recipe_discovery_item_desc", &self.crafting_recipe_discovery_item_desc);
        diff.crafting_recipe_discovery_knowledge_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("crafting_recipe_discovery_knowledge_desc", &self.crafting_recipe_discovery_knowledge_desc);
        diff.crumb_tail_cleanup_timer = cache.apply_diff_to_table::<CrumbTrailCleanupTimer>("crumb_tail_cleanup_timer", &self.crumb_tail_cleanup_timer).with_updates_by_pk(|row| &row.scheduled_id);
        ...
        diff.crumb_trail_state = cache.apply_diff_to_table::<CrumbTrailState>("crumb_trail_state", &self.crumb_trail_state).with_updates_by_pk(|row| &row.entity_id);
        ...
        diff.enemy_scaling_state = cache.apply_diff_to_table::<EnemyScalingState>("enemy_scaling_state", &self.enemy_scaling_state).with_updates_by_pk(|row| &row.entity_id);
        ...
        diff.inter_module_message_errors = cache.apply_diff_to_table::<InterModuleMessageErrors>("inter_module_message_errors", &self.inter_module_message_errors).with_updates_by_pk(|row| &row.sender_module_id);
        ...
        diff.migration_achievements_params = cache.apply_diff_to_table::<MigrationAchievementsParams>("migration_achievements_params", &self.migration_achievements_params).with_updates_by_pk(|row| &row.id);
        diff.migration_building_desc_params = cache.apply_diff_to_table::<MigrationBuildingDescParams>("migration_building_desc_params", &self.migration_building_desc_params).with_updates_by_pk(|row| &row.id);
        ...
        diff.paving_recipe_discovery_cargo_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("paving_recipe_discovery_cargo_desc", &self.paving_recipe_discovery_cargo_desc);
        diff.paving_recipe_discovery_item_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("paving_recipe_discovery_item_desc", &self.paving_recipe_discovery_item_desc);
        diff.paving_recipe_discovery_knowledge_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("paving_recipe_discovery_knowledge_desc", &self.paving_recipe_discovery_knowledge_desc);
        ...
        diff.pillar_shaping_recipe_discovery_cargo_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("pillar_shaping_recipe_discovery_cargo_desc", &self.pillar_shaping_recipe_discovery_cargo_desc);
        diff.pillar_shaping_recipe_discovery_item_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("pillar_shaping_recipe_discovery_item_desc", &self.pillar_shaping_recipe_discovery_item_desc);
        diff.pillar_shaping_recipe_discovery_knowledge_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("pillar_shaping_recipe_discovery_knowledge_desc", &self.pillar_shaping_recipe_discovery_knowledge_desc);
        ...
        diff.previous_empire_name_state = cache.apply_diff_to_table::<PreviousEmpireNameState>("previous_empire_name_state", &self.previous_empire_name_state).with_updates_by_pk(|row| &row.emperor_identity);
        diff.previous_player_skills_state = cache.apply_diff_to_table::<PreviousPlayerSkillsState>("previous_player_skills_state", &self.previous_player_skills_state).with_updates_by_pk(|row| &row.identity);
        diff.previous_player_username_state = cache.apply_diff_to_table::<PreviousPlayerUsernameState>("previous_player_username_state", &self.previous_player_username_state);
        ...
        diff.region_moderation_config_state = cache.apply_diff_to_table::<RegionModerationConfigState>("region_moderation_config_state", &self.region_moderation_config_state).with_updates_by_pk(|row| &row.id);
        ...
        diff.resource_placement_recipe_discovery_cargo_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("resource_placement_recipe_discovery_cargo_desc", &self.resource_placement_recipe_discovery_cargo_desc);
        diff.resource_placement_recipe_discovery_item_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("resource_placement_recipe_discovery_item_desc", &self.resource_placement_recipe_discovery_item_desc);
        diff.resource_placement_recipe_discovery_knowledge_desc = cache.apply_diff_to_table::<DiscoveryTriggerDesc>("resource_placement_recipe_discovery_knowledge_desc", &self.resource_placement_recipe_discovery_knowledge_desc);
        ...
        diff.staged_ability_custom_desc = cache.apply_diff_to_table::<AbilityCustomDesc>("staged_ability_custom_desc", &self.staged_ability_custom_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_ability_unlock_desc = cache.apply_diff_to_table::<AbilityUnlockDesc>("staged_ability_unlock_desc", &self.staged_ability_unlock_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_achievement_desc = cache.apply_diff_to_table::<AchievementDesc>("staged_achievement_desc", &self.staged_achievement_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_alert_desc = cache.apply_diff_to_table::<AlertDesc>("staged_alert_desc", &self.staged_alert_desc).with_updates_by_pk(|row| &row.alert_type);
        diff.staged_biome_desc = cache.apply_diff_to_table::<BiomeDesc>("staged_biome_desc", &self.staged_biome_desc).with_updates_by_pk(|row| &row.biome_type);
        diff.staged_buff_desc = cache.apply_diff_to_table::<BuffDesc>("staged_buff_desc", &self.staged_buff_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_buff_type_desc = cache.apply_diff_to_table::<BuffTypeDesc>("staged_buff_type_desc", &self.staged_buff_type_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_building_buff_desc = cache.apply_diff_to_table::<BuildingBuffDesc>("staged_building_buff_desc", &self.staged_building_buff_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_building_claim_desc = cache.apply_diff_to_table::<BuildingClaimDesc>("staged_building_claim_desc", &self.staged_building_claim_desc).with_updates_by_pk(|row| &row.building_id);
        diff.staged_building_desc = cache.apply_diff_to_table::<BuildingDesc>("staged_building_desc", &self.staged_building_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_building_portal_desc = cache.apply_diff_to_table::<BuildingPortalDesc>("staged_building_portal_desc", &self.staged_building_portal_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_building_repairs_desc = cache.apply_diff_to_table::<BuildingRepairsDesc>("staged_building_repairs_desc", &self.staged_building_repairs_desc).with_updates_by_pk(|row| &row.cargo_id);
        diff.staged_building_spawn_desc = cache.apply_diff_to_table::<BuildingSpawnDesc>("staged_building_spawn_desc", &self.staged_building_spawn_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_building_type_desc = cache.apply_diff_to_table::<BuildingTypeDesc>("staged_building_type_desc", &self.staged_building_type_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_cargo_desc = cache.apply_diff_to_table::<CargoDesc>("staged_cargo_desc", &self.staged_cargo_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_character_stat_desc = cache.apply_diff_to_table::<CharacterStatDesc>("staged_character_stat_desc", &self.staged_character_stat_desc).with_updates_by_pk(|row| &row.stat_type);
        diff.staged_chest_rarity_desc = cache.apply_diff_to_table::<ChestRarityDesc>("staged_chest_rarity_desc", &self.staged_chest_rarity_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_claim_tech_desc = cache.apply_diff_to_table::<ClaimTechDesc>("staged_claim_tech_desc", &self.staged_claim_tech_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_claim_tile_cost = cache.apply_diff_to_table::<ClaimTileCost>("staged_claim_tile_cost", &self.staged_claim_tile_cost).with_updates_by_pk(|row| &row.tile_count);
        diff.staged_climb_requirement_desc = cache.apply_diff_to_table::<ClimbRequirementDesc>("staged_climb_requirement_desc", &self.staged_climb_requirement_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_clothing_desc = cache.apply_diff_to_table::<ClothingDesc>("staged_clothing_desc", &self.staged_clothing_desc).with_updates_by_pk(|row| &row.item_id);
        diff.staged_collectible_desc = cache.apply_diff_to_table::<CollectibleDesc>("staged_collectible_desc", &self.staged_collectible_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_combat_action_desc = cache.apply_diff_to_table::<CombatActionDesc>("staged_combat_action_desc", &self.staged_combat_action_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_combat_action_multi_hit_desc = cache.apply_diff_to_table::<CombatActionMultiHitDesc>("staged_combat_action_multi_hit_desc", &self.staged_combat_action_multi_hit_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_construction_recipe_desc = cache.apply_diff_to_table::<ConstructionRecipeDesc>("staged_construction_recipe_desc", &self.staged_construction_recipe_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_contribution_loot_desc = cache.apply_diff_to_table::<ContributionLootDesc>("staged_contribution_loot_desc", &self.staged_contribution_loot_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_crafting_recipe_desc = cache.apply_diff_to_table::<CraftingRecipeDesc>("staged_crafting_recipe_desc", &self.staged_crafting_recipe_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_deconstruction_recipe_desc = cache.apply_diff_to_table::<DeconstructionRecipeDesc>("staged_deconstruction_recipe_desc", &self.staged_deconstruction_recipe_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_deployable_desc = cache.apply_diff_to_table::<DeployableDesc>("staged_deployable_desc", &self.staged_deployable_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_distant_visible_entity_desc = cache.apply_diff_to_table::<DistantVisibleEntityDesc>("staged_distant_visible_entity_desc", &self.staged_distant_visible_entity_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_elevator_desc = cache.apply_diff_to_table::<ElevatorDesc>("staged_elevator_desc", &self.staged_elevator_desc).with_updates_by_pk(|row| &row.building_id);
        diff.staged_emote_desc = cache.apply_diff_to_table::<EmoteDesc>("staged_emote_desc", &self.staged_emote_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_empire_colors_desc = cache.apply_diff_to_table::<EmpireColorDesc>("staged_empire_colors_desc", &self.staged_empire_colors_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_empire_icon_desc = cache.apply_diff_to_table::<EmpireIconDesc>("staged_empire_icon_desc", &self.staged_empire_icon_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_empire_notification_desc = cache.apply_diff_to_table::<EmpireNotificationDesc>("staged_empire_notification_desc", &self.staged_empire_notification_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_empire_rank_desc = cache.apply_diff_to_table::<EmpireRankDesc>("staged_empire_rank_desc", &self.staged_empire_rank_desc).with_updates_by_pk(|row| &row.rank);
        diff.staged_empire_supplies_desc = cache.apply_diff_to_table::<EmpireSuppliesDesc>("staged_empire_supplies_desc", &self.staged_empire_supplies_desc).with_updates_by_pk(|row| &row.cargo_id);
        diff.staged_empire_territory_desc = cache.apply_diff_to_table::<EmpireTerritoryDesc>("staged_empire_territory_desc", &self.staged_empire_territory_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_enemy_ai_params_desc = cache.apply_diff_to_table::<EnemyAiParamsDesc>("staged_enemy_ai_params_desc", &self.staged_enemy_ai_params_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_enemy_desc = cache.apply_diff_to_table::<EnemyDesc>("staged_enemy_desc", &self.staged_enemy_desc).with_updates_by_pk(|row| &row.enemy_type);
        diff.staged_enemy_scaling_desc = cache.apply_diff_to_table::<EnemyScalingDesc>("staged_enemy_scaling_desc", &self.staged_enemy_scaling_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_environment_debuff_desc = cache.apply_diff_to_table::<EnvironmentDebuffDesc>("staged_environment_debuff_desc", &self.staged_environment_debuff_desc).with_updates_by_pk(|row| &row.buff_id);
        diff.staged_equipment_desc = cache.apply_diff_to_table::<EquipmentDesc>("staged_equipment_desc", &self.staged_equipment_desc).with_updates_by_pk(|row| &row.item_id);
        diff.staged_extraction_recipe_desc = cache.apply_diff_to_table::<ExtractionRecipeDesc>("staged_extraction_recipe_desc", &self.staged_extraction_recipe_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_food_desc = cache.apply_diff_to_table::<FoodDesc>("staged_food_desc", &self.staged_food_desc).with_updates_by_pk(|row| &row.item_id);
        diff.staged_gate_desc = cache.apply_diff_to_table::<GateDesc>("staged_gate_desc", &self.staged_gate_desc).with_updates_by_pk(|row| &row.building_id);
        diff.staged_hexite_exchange_entry_desc = cache.apply_diff_to_table::<HexiteExchangeEntryDesc>("staged_hexite_exchange_entry_desc", &self.staged_hexite_exchange_entry_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_interior_environment_desc = cache.apply_diff_to_table::<InteriorEnvironmentDesc>("staged_interior_environment_desc", &self.staged_interior_environment_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_interior_instance_desc = cache.apply_diff_to_table::<InteriorInstanceDesc>("staged_interior_instance_desc", &self.staged_interior_instance_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_interior_network_desc = cache.apply_diff_to_table::<InteriorNetworkDesc>("staged_interior_network_desc", &self.staged_interior_network_desc).with_updates_by_pk(|row| &row.building_id);
        diff.staged_interior_portal_connections_desc = cache.apply_diff_to_table::<InteriorPortalConnectionsDesc>("staged_interior_portal_connections_desc", &self.staged_interior_portal_connections_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_interior_shape_desc = cache.apply_diff_to_table::<InteriorShapeDesc>("staged_interior_shape_desc", &self.staged_interior_shape_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_interior_spawn_desc = cache.apply_diff_to_table::<InteriorSpawnDesc>("staged_interior_spawn_desc", &self.staged_interior_spawn_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_item_conversion_recipe_desc = cache.apply_diff_to_table::<ItemConversionRecipeDesc>("staged_item_conversion_recipe_desc", &self.staged_item_conversion_recipe_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_item_desc = cache.apply_diff_to_table::<ItemDesc>("staged_item_desc", &self.staged_item_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_item_list_desc = cache.apply_diff_to_table::<ItemListDesc>("staged_item_list_desc", &self.staged_item_list_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_knowledge_scroll_desc = cache.apply_diff_to_table::<KnowledgeScrollDesc>("staged_knowledge_scroll_desc", &self.staged_knowledge_scroll_desc).with_updates_by_pk(|row| &row.item_id);
        diff.staged_knowledge_scroll_type_desc = cache.apply_diff_to_table::<KnowledgeScrollTypeDesc>("staged_knowledge_scroll_type_desc", &self.staged_knowledge_scroll_type_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_knowledge_stat_modifier_desc = cache.apply_diff_to_table::<KnowledgeStatModifierDesc>("staged_knowledge_stat_modifier_desc", &self.staged_knowledge_stat_modifier_desc).with_updates_by_pk(|row| &row.secondary_knowledge_id);
        diff.staged_loot_chest_desc = cache.apply_diff_to_table::<LootChestDesc>("staged_loot_chest_desc", &self.staged_loot_chest_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_loot_rarity_desc = cache.apply_diff_to_table::<LootRarityDesc>("staged_loot_rarity_desc", &self.staged_loot_rarity_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_loot_table_desc = cache.apply_diff_to_table::<LootTableDesc>("staged_loot_table_desc", &self.staged_loot_table_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_npc_desc = cache.apply_diff_to_table::<NpcDesc>("staged_npc_desc", &self.staged_npc_desc).with_updates_by_pk(|row| &row.npc_type);
        diff.staged_onboarding_reward_desc = cache.apply_diff_to_table::<OnboardingRewardDesc>("staged_onboarding_reward_desc", &self.staged_onboarding_reward_desc).with_updates_by_pk(|row| &row.state_id);
        diff.staged_parameters_desc = cache.apply_diff_to_table::<ParametersDesc>("staged_parameters_desc", &self.staged_parameters_desc).with_updates_by_pk(|row| &row.version);
        diff.staged_pathfinding_desc = cache.apply_diff_to_table::<PathfindingDesc>("staged_pathfinding_desc", &self.staged_pathfinding_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_paving_tile_desc = cache.apply_diff_to_table::<PavingTileDesc>("staged_paving_tile_desc", &self.staged_paving_tile_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_pillar_shaping_desc = cache.apply_diff_to_table::<PillarShapingDesc>("staged_pillar_shaping_desc", &self.staged_pillar_shaping_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_player_action_desc = cache.apply_diff_to_table::<PlayerActionDesc>("staged_player_action_desc", &self.staged_player_action_desc).with_updates_by_pk(|row| &row.action_type_id);
        diff.staged_player_housing_desc = cache.apply_diff_to_table::<PlayerHousingDesc>("staged_player_housing_desc", &self.staged_player_housing_desc).with_updates_by_pk(|row| &row.secondary_knowledge_id);
        diff.staged_premium_item_desc = cache.apply_diff_to_table::<PremiumItemDesc>("staged_premium_item_desc", &self.staged_premium_item_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_premium_service_desc = cache.apply_diff_to_table::<PremiumServiceDesc>("staged_premium_service_desc", &self.staged_premium_service_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_private_parameters_desc = cache.apply_diff_to_table::<PrivateParametersDesc>("staged_private_parameters_desc", &self.staged_private_parameters_desc).with_updates_by_pk(|row| &row.version);
        diff.staged_prospecting_desc = cache.apply_diff_to_table::<ProspectingDesc>("staged_prospecting_desc", &self.staged_prospecting_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_quest_chain_desc = cache.apply_diff_to_table::<QuestChainDesc>("staged_quest_chain_desc", &self.staged_quest_chain_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_quest_stage_desc = cache.apply_diff_to_table::<QuestStageDesc>("staged_quest_stage_desc", &self.staged_quest_stage_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_reserved_name_desc = cache.apply_diff_to_table::<ReservedNameDesc>("staged_reserved_name_desc", &self.staged_reserved_name_desc).with_updates_by_pk(|row| &row.name);
        diff.staged_resource_clump_desc = cache.apply_diff_to_table::<ResourceClumpDesc>("staged_resource_clump_desc", &self.staged_resource_clump_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_resource_desc = cache.apply_diff_to_table::<ResourceDesc>("staged_resource_desc", &self.staged_resource_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_resource_growth_recipe_desc = cache.apply_diff_to_table::<ResourceGrowthRecipeDesc>("staged_resource_growth_recipe_desc", &self.staged_resource_growth_recipe_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_resource_placement_recipe_desc = cache.apply_diff_to_table::<ResourcePlacementRecipeDesc>("staged_resource_placement_recipe_desc", &self.staged_resource_placement_recipe_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_secondary_knowledge_desc = cache.apply_diff_to_table::<SecondaryKnowledgeDesc>("staged_secondary_knowledge_desc", &self.staged_secondary_knowledge_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_skill_desc = cache.apply_diff_to_table::<SkillDesc>("staged_skill_desc", &self.staged_skill_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_stage_rewards_desc = cache.apply_diff_to_table::<StageRewardsDesc>("staged_stage_rewards_desc", &self.staged_stage_rewards_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_targeting_matrix_desc = cache.apply_diff_to_table::<TargetingMatrixDesc>("staged_targeting_matrix_desc", &self.staged_targeting_matrix_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_teleport_item_desc = cache.apply_diff_to_table::<TeleportItemDesc>("staged_teleport_item_desc", &self.staged_teleport_item_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_terraform_recipe_desc = cache.apply_diff_to_table::<TerraformRecipeDesc>("staged_terraform_recipe_desc", &self.staged_terraform_recipe_desc).with_updates_by_pk(|row| &row.difference);
        diff.staged_tool_desc = cache.apply_diff_to_table::<ToolDesc>("staged_tool_desc", &self.staged_tool_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_tool_type_desc = cache.apply_diff_to_table::<ToolTypeDesc>("staged_tool_type_desc", &self.staged_tool_type_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_traveler_task_desc = cache.apply_diff_to_table::<TravelerTaskDesc>("staged_traveler_task_desc", &self.staged_traveler_task_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_traveler_trade_order_desc = cache.apply_diff_to_table::<TravelerTradeOrderDesc>("staged_traveler_trade_order_desc", &self.staged_traveler_trade_order_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_wall_desc = cache.apply_diff_to_table::<WallDesc>("staged_wall_desc", &self.staged_wall_desc).with_updates_by_pk(|row| &row.building_id);
        diff.staged_weapon_desc = cache.apply_diff_to_table::<WeaponDesc>("staged_weapon_desc", &self.staged_weapon_desc).with_updates_by_pk(|row| &row.item_id);
        diff.staged_weapon_type_desc = cache.apply_diff_to_table::<WeaponTypeDesc>("staged_weapon_type_desc", &self.staged_weapon_type_desc).with_updates_by_pk(|row| &row.id);
        diff.staged_wind_params_desc = cache.apply_diff_to_table::<WindParamsDesc>("staged_wind_params_desc", &self.staged_wind_params_desc).with_updates_by_pk(|row| &row.id);
        ...
        diff.storage_log_cleanup_loop_timer = cache.apply_diff_to_table::<StorageLogCleanupLoopTimer>("storage_log_cleanup_loop_timer", &self.storage_log_cleanup_loop_timer).with_updates_by_pk(|row| &row.scheduled_id);
        ...
        diff.world_entity_placement_results = cache.apply_diff_to_table::<WorldEntityPlacementResults>("world_entity_placement_results", &self.world_entity_placement_results).with_updates_by_pk(|row| &row.entity_id);
...
pub struct AppliedDiff<'r> {
    ...
    pillar_shaping_recipe_discovery_knowledge_desc: __sdk::TableAppliedDiff<'r, DiscoveryTriggerDesc>,
    ...
    resource_placement_recipe_discovery_cargo_desc: __sdk::TableAppliedDiff<'r, DiscoveryTriggerDesc>,
    resource_placement_recipe_discovery_item_desc: __sdk::TableAppliedDiff<'r, DiscoveryTriggerDesc>,
    resource_placement_recipe_discovery_knowledge_desc: __sdk::TableAppliedDiff<'r, DiscoveryTriggerDesc>,
    ...
    staged_interior_portal_connections_desc: __sdk::TableAppliedDiff<'r, InteriorPortalConnectionsDesc>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(&self, event: &EventContext, callbacks: &mut __sdk::DbCallbacks<RemoteModule>) {
        ...
        callbacks.invoke_table_row_callbacks::<ActiveEnvironmentBuffState>("active_environment_buff_state", &self.active_environment_buff_state, event);
        ...
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("construction_recipe_discovery_cargo_desc", &self.construction_recipe_discovery_cargo_desc, event);
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("construction_recipe_discovery_item_desc", &self.construction_recipe_discovery_item_desc, event);
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("construction_recipe_discovery_knowledge_desc", &self.construction_recipe_discovery_knowledge_desc, event);
        ...
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("crafting_recipe_discovery_cargo_desc", &self.crafting_recipe_discovery_cargo_desc, event);
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("crafting_recipe_discovery_item_desc", &self.crafting_recipe_discovery_item_desc, event);
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("crafting_recipe_discovery_knowledge_desc", &self.crafting_recipe_discovery_knowledge_desc, event);
        callbacks.invoke_table_row_callbacks::<CrumbTrailCleanupTimer>("crumb_tail_cleanup_timer", &self.crumb_tail_cleanup_timer, event);
        ...
        callbacks.invoke_table_row_callbacks::<CrumbTrailState>("crumb_trail_state", &self.crumb_trail_state, event);
        ...
        callbacks.invoke_table_row_callbacks::<EnemyScalingState>("enemy_scaling_state", &self.enemy_scaling_state, event);
        ...
        callbacks.invoke_table_row_callbacks::<InterModuleMessageErrors>("inter_module_message_errors", &self.inter_module_message_errors, event);
        ...
        callbacks.invoke_table_row_callbacks::<MigrationAchievementsParams>("migration_achievements_params", &self.migration_achievements_params, event);
        callbacks.invoke_table_row_callbacks::<MigrationBuildingDescParams>("migration_building_desc_params", &self.migration_building_desc_params, event);
        ...
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("paving_recipe_discovery_cargo_desc", &self.paving_recipe_discovery_cargo_desc, event);
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("paving_recipe_discovery_item_desc", &self.paving_recipe_discovery_item_desc, event);
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("paving_recipe_discovery_knowledge_desc", &self.paving_recipe_discovery_knowledge_desc, event);
        ...
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("pillar_shaping_recipe_discovery_cargo_desc", &self.pillar_shaping_recipe_discovery_cargo_desc, event);
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("pillar_shaping_recipe_discovery_item_desc", &self.pillar_shaping_recipe_discovery_item_desc, event);
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("pillar_shaping_recipe_discovery_knowledge_desc", &self.pillar_shaping_recipe_discovery_knowledge_desc, event);
        ...
        callbacks.invoke_table_row_callbacks::<PreviousEmpireNameState>("previous_empire_name_state", &self.previous_empire_name_state, event);
        callbacks.invoke_table_row_callbacks::<PreviousPlayerSkillsState>("previous_player_skills_state", &self.previous_player_skills_state, event);
        callbacks.invoke_table_row_callbacks::<PreviousPlayerUsernameState>("previous_player_username_state", &self.previous_player_username_state, event);
        ...
        callbacks.invoke_table_row_callbacks::<RegionModerationConfigState>("region_moderation_config_state", &self.region_moderation_config_state, event);
        ...
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("resource_placement_recipe_discovery_cargo_desc", &self.resource_placement_recipe_discovery_cargo_desc, event);
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("resource_placement_recipe_discovery_item_desc", &self.resource_placement_recipe_discovery_item_desc, event);
        callbacks.invoke_table_row_callbacks::<DiscoveryTriggerDesc>("resource_placement_recipe_discovery_knowledge_desc", &self.resource_placement_recipe_discovery_knowledge_desc, event);
        ...
        callbacks.invoke_table_row_callbacks::<AbilityCustomDesc>("staged_ability_custom_desc", &self.staged_ability_custom_desc, event);
        callbacks.invoke_table_row_callbacks::<AbilityUnlockDesc>("staged_ability_unlock_desc", &self.staged_ability_unlock_desc, event);
        callbacks.invoke_table_row_callbacks::<AchievementDesc>("staged_achievement_desc", &self.staged_achievement_desc, event);
        callbacks.invoke_table_row_callbacks::<AlertDesc>("staged_alert_desc", &self.staged_alert_desc, event);
        callbacks.invoke_table_row_callbacks::<BiomeDesc>("staged_biome_desc", &self.staged_biome_desc, event);
        callbacks.invoke_table_row_callbacks::<BuffDesc>("staged_buff_desc", &self.staged_buff_desc, event);
        callbacks.invoke_table_row_callbacks::<BuffTypeDesc>("staged_buff_type_desc", &self.staged_buff_type_desc, event);
        callbacks.invoke_table_row_callbacks::<BuildingBuffDesc>("staged_building_buff_desc", &self.staged_building_buff_desc, event);
        callbacks.invoke_table_row_callbacks::<BuildingClaimDesc>("staged_building_claim_desc", &self.staged_building_claim_desc, event);
        callbacks.invoke_table_row_callbacks::<BuildingDesc>("staged_building_desc", &self.staged_building_desc, event);
        callbacks.invoke_table_row_callbacks::<BuildingPortalDesc>("staged_building_portal_desc", &self.staged_building_portal_desc, event);
        callbacks.invoke_table_row_callbacks::<BuildingRepairsDesc>("staged_building_repairs_desc", &self.staged_building_repairs_desc, event);
        callbacks.invoke_table_row_callbacks::<BuildingSpawnDesc>("staged_building_spawn_desc", &self.staged_building_spawn_desc, event);
        callbacks.invoke_table_row_callbacks::<BuildingTypeDesc>("staged_building_type_desc", &self.staged_building_type_desc, event);
        callbacks.invoke_table_row_callbacks::<CargoDesc>("staged_cargo_desc", &self.staged_cargo_desc, event);
        callbacks.invoke_table_row_callbacks::<CharacterStatDesc>("staged_character_stat_desc", &self.staged_character_stat_desc, event);
        callbacks.invoke_table_row_callbacks::<ChestRarityDesc>("staged_chest_rarity_desc", &self.staged_chest_rarity_desc, event);
        callbacks.invoke_table_row_callbacks::<ClaimTechDesc>("staged_claim_tech_desc", &self.staged_claim_tech_desc, event);
        callbacks.invoke_table_row_callbacks::<ClaimTileCost>("staged_claim_tile_cost", &self.staged_claim_tile_cost, event);
        callbacks.invoke_table_row_callbacks::<ClimbRequirementDesc>("staged_climb_requirement_desc", &self.staged_climb_requirement_desc, event);
        callbacks.invoke_table_row_callbacks::<ClothingDesc>("staged_clothing_desc", &self.staged_clothing_desc, event);
        callbacks.invoke_table_row_callbacks::<CollectibleDesc>("staged_collectible_desc", &self.staged_collectible_desc, event);
        callbacks.invoke_table_row_callbacks::<CombatActionDesc>("staged_combat_action_desc", &self.staged_combat_action_desc, event);
        callbacks.invoke_table_row_callbacks::<CombatActionMultiHitDesc>("staged_combat_action_multi_hit_desc", &self.staged_combat_action_multi_hit_desc, event);
        callbacks.invoke_table_row_callbacks::<ConstructionRecipeDesc>("staged_construction_recipe_desc", &self.staged_construction_recipe_desc, event);
        callbacks.invoke_table_row_callbacks::<ContributionLootDesc>("staged_contribution_loot_desc", &self.staged_contribution_loot_desc, event);
        callbacks.invoke_table_row_callbacks::<CraftingRecipeDesc>("staged_crafting_recipe_desc", &self.staged_crafting_recipe_desc, event);
        callbacks.invoke_table_row_callbacks::<DeconstructionRecipeDesc>("staged_deconstruction_recipe_desc", &self.staged_deconstruction_recipe_desc, event);
        callbacks.invoke_table_row_callbacks::<DeployableDesc>("staged_deployable_desc", &self.staged_deployable_desc, event);
        callbacks.invoke_table_row_callbacks::<DistantVisibleEntityDesc>("staged_distant_visible_entity_desc", &self.staged_distant_visible_entity_desc, event);
        callbacks.invoke_table_row_callbacks::<ElevatorDesc>("staged_elevator_desc", &self.staged_elevator_desc, event);
        callbacks.invoke_table_row_callbacks::<EmoteDesc>("staged_emote_desc", &self.staged_emote_desc, event);
        callbacks.invoke_table_row_callbacks::<EmpireColorDesc>("staged_empire_colors_desc", &self.staged_empire_colors_desc, event);
        callbacks.invoke_table_row_callbacks::<EmpireIconDesc>("staged_empire_icon_desc", &self.staged_empire_icon_desc, event);
        callbacks.invoke_table_row_callbacks::<EmpireNotificationDesc>("staged_empire_notification_desc", &self.staged_empire_notification_desc, event);
        callbacks.invoke_table_row_callbacks::<EmpireRankDesc>("staged_empire_rank_desc", &self.staged_empire_rank_desc, event);
        callbacks.invoke_table_row_callbacks::<EmpireSuppliesDesc>("staged_empire_supplies_desc", &self.staged_empire_supplies_desc, event);
        callbacks.invoke_table_row_callbacks::<EmpireTerritoryDesc>("staged_empire_territory_desc", &self.staged_empire_territory_desc, event);
        callbacks.invoke_table_row_callbacks::<EnemyAiParamsDesc>("staged_enemy_ai_params_desc", &self.staged_enemy_ai_params_desc, event);
        callbacks.invoke_table_row_callbacks::<EnemyDesc>("staged_enemy_desc", &self.staged_enemy_desc, event);
        callbacks.invoke_table_row_callbacks::<EnemyScalingDesc>("staged_enemy_scaling_desc", &self.staged_enemy_scaling_desc, event);
        callbacks.invoke_table_row_callbacks::<EnvironmentDebuffDesc>("staged_environment_debuff_desc", &self.staged_environment_debuff_desc, event);
        callbacks.invoke_table_row_callbacks::<EquipmentDesc>("staged_equipment_desc", &self.staged_equipment_desc, event);
        callbacks.invoke_table_row_callbacks::<ExtractionRecipeDesc>("staged_extraction_recipe_desc", &self.staged_extraction_recipe_desc, event);
        callbacks.invoke_table_row_callbacks::<FoodDesc>("staged_food_desc", &self.staged_food_desc, event);
        callbacks.invoke_table_row_callbacks::<GateDesc>("staged_gate_desc", &self.staged_gate_desc, event);
        callbacks.invoke_table_row_callbacks::<HexiteExchangeEntryDesc>("staged_hexite_exchange_entry_desc", &self.staged_hexite_exchange_entry_desc, event);
        callbacks.invoke_table_row_callbacks::<InteriorEnvironmentDesc>("staged_interior_environment_desc", &self.staged_interior_environment_desc, event);
        callbacks.invoke_table_row_callbacks::<InteriorInstanceDesc>("staged_interior_instance_desc", &self.staged_interior_instance_desc, event);
        callbacks.invoke_table_row_callbacks::<InteriorNetworkDesc>("staged_interior_network_desc", &self.staged_interior_network_desc, event);
        callbacks.invoke_table_row_callbacks::<InteriorPortalConnectionsDesc>("staged_interior_portal_connections_desc", &self.staged_interior_portal_connections_desc, event);
        callbacks.invoke_table_row_callbacks::<InteriorShapeDesc>("staged_interior_shape_desc", &self.staged_interior_shape_desc, event);
        callbacks.invoke_table_row_callbacks::<InteriorSpawnDesc>("staged_interior_spawn_desc", &self.staged_interior_spawn_desc, event);
        callbacks.invoke_table_row_callbacks::<ItemConversionRecipeDesc>("staged_item_conversion_recipe_desc", &self.staged_item_conversion_recipe_desc, event);
        callbacks.invoke_table_row_callbacks::<ItemDesc>("staged_item_desc", &self.staged_item_desc, event);
        callbacks.invoke_table_row_callbacks::<ItemListDesc>("staged_item_list_desc", &self.staged_item_list_desc, event);
        callbacks.invoke_table_row_callbacks::<KnowledgeScrollDesc>("staged_knowledge_scroll_desc", &self.staged_knowledge_scroll_desc, event);
        callbacks.invoke_table_row_callbacks::<KnowledgeScrollTypeDesc>("staged_knowledge_scroll_type_desc", &self.staged_knowledge_scroll_type_desc, event);
        callbacks.invoke_table_row_callbacks::<KnowledgeStatModifierDesc>("staged_knowledge_stat_modifier_desc", &self.staged_knowledge_stat_modifier_desc, event);
        callbacks.invoke_table_row_callbacks::<LootChestDesc>("staged_loot_chest_desc", &self.staged_loot_chest_desc, event);
        callbacks.invoke_table_row_callbacks::<LootRarityDesc>("staged_loot_rarity_desc", &self.staged_loot_rarity_desc, event);
        callbacks.invoke_table_row_callbacks::<LootTableDesc>("staged_loot_table_desc", &self.staged_loot_table_desc, event);
        callbacks.invoke_table_row_callbacks::<NpcDesc>("staged_npc_desc", &self.staged_npc_desc, event);
        callbacks.invoke_table_row_callbacks::<OnboardingRewardDesc>("staged_onboarding_reward_desc", &self.staged_onboarding_reward_desc, event);
        callbacks.invoke_table_row_callbacks::<ParametersDesc>("staged_parameters_desc", &self.staged_parameters_desc, event);
        callbacks.invoke_table_row_callbacks::<PathfindingDesc>("staged_pathfinding_desc", &self.staged_pathfinding_desc, event);
        callbacks.invoke_table_row_callbacks::<PavingTileDesc>("staged_paving_tile_desc", &self.staged_paving_tile_desc, event);
        callbacks.invoke_table_row_callbacks::<PillarShapingDesc>("staged_pillar_shaping_desc", &self.staged_pillar_shaping_desc, event);
        callbacks.invoke_table_row_callbacks::<PlayerActionDesc>("staged_player_action_desc", &self.staged_player_action_desc, event);
        callbacks.invoke_table_row_callbacks::<PlayerHousingDesc>("staged_player_housing_desc", &self.staged_player_housing_desc, event);
        callbacks.invoke_table_row_callbacks::<PremiumItemDesc>("staged_premium_item_desc", &self.staged_premium_item_desc, event);
        callbacks.invoke_table_row_callbacks::<PremiumServiceDesc>("staged_premium_service_desc", &self.staged_premium_service_desc, event);
        callbacks.invoke_table_row_callbacks::<PrivateParametersDesc>("staged_private_parameters_desc", &self.staged_private_parameters_desc, event);
        callbacks.invoke_table_row_callbacks::<ProspectingDesc>("staged_prospecting_desc", &self.staged_prospecting_desc, event);
        callbacks.invoke_table_row_callbacks::<QuestChainDesc>("staged_quest_chain_desc", &self.staged_quest_chain_desc, event);
        callbacks.invoke_table_row_callbacks::<QuestStageDesc>("staged_quest_stage_desc", &self.staged_quest_stage_desc, event);
        callbacks.invoke_table_row_callbacks::<ReservedNameDesc>("staged_reserved_name_desc", &self.staged_reserved_name_desc, event);
        callbacks.invoke_table_row_callbacks::<ResourceClumpDesc>("staged_resource_clump_desc", &self.staged_resource_clump_desc, event);
        callbacks.invoke_table_row_callbacks::<ResourceDesc>("staged_resource_desc", &self.staged_resource_desc, event);
        callbacks.invoke_table_row_callbacks::<ResourceGrowthRecipeDesc>("staged_resource_growth_recipe_desc", &self.staged_resource_growth_recipe_desc, event);
        callbacks.invoke_table_row_callbacks::<ResourcePlacementRecipeDesc>("staged_resource_placement_recipe_desc", &self.staged_resource_placement_recipe_desc, event);
        callbacks.invoke_table_row_callbacks::<SecondaryKnowledgeDesc>("staged_secondary_knowledge_desc", &self.staged_secondary_knowledge_desc, event);
        callbacks.invoke_table_row_callbacks::<SkillDesc>("staged_skill_desc", &self.staged_skill_desc, event);
        callbacks.invoke_table_row_callbacks::<StageRewardsDesc>("staged_stage_rewards_desc", &self.staged_stage_rewards_desc, event);
        callbacks.invoke_table_row_callbacks::<TargetingMatrixDesc>("staged_targeting_matrix_desc", &self.staged_targeting_matrix_desc, event);
        callbacks.invoke_table_row_callbacks::<TeleportItemDesc>("staged_teleport_item_desc", &self.staged_teleport_item_desc, event);
        callbacks.invoke_table_row_callbacks::<TerraformRecipeDesc>("staged_terraform_recipe_desc", &self.staged_terraform_recipe_desc, event);
        callbacks.invoke_table_row_callbacks::<ToolDesc>("staged_tool_desc", &self.staged_tool_desc, event);
        callbacks.invoke_table_row_callbacks::<ToolTypeDesc>("staged_tool_type_desc", &self.staged_tool_type_desc, event);
        callbacks.invoke_table_row_callbacks::<TravelerTaskDesc>("staged_traveler_task_desc", &self.staged_traveler_task_desc, event);
        callbacks.invoke_table_row_callbacks::<TravelerTradeOrderDesc>("staged_traveler_trade_order_desc", &self.staged_traveler_trade_order_desc, event);
        callbacks.invoke_table_row_callbacks::<WallDesc>("staged_wall_desc", &self.staged_wall_desc, event);
        callbacks.invoke_table_row_callbacks::<WeaponDesc>("staged_weapon_desc", &self.staged_weapon_desc, event);
        callbacks.invoke_table_row_callbacks::<WeaponTypeDesc>("staged_weapon_type_desc", &self.staged_weapon_type_desc, event);
        callbacks.invoke_table_row_callbacks::<WindParamsDesc>("staged_wind_params_desc", &self.staged_wind_params_desc, event);
        ...
        callbacks.invoke_table_row_callbacks::<StorageLogCleanupLoopTimer>("storage_log_cleanup_loop_timer", &self.storage_log_cleanup_loop_timer, event);
        ...
        callbacks.invoke_table_row_callbacks::<WorldEntityPlacementResults>("world_entity_placement_results", &self.world_entity_placement_results, event);
