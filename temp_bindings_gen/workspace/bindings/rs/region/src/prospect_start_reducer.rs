...
timestamp: u64,
    ...
    fn on_prospect_start(&self, callback: impl FnMut(&super::ReducerEventContext, &i32, &u64, ) + Send + 'static) -> ProspectStartCallbackId;
...
timestamp: u64,
        ...
        self.imp.call_reducer("prospect_start", ProspectStartArgs { prospecting_id, timestamp,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::ProspectStart {
                            prospecting_id, timestamp, 
                        },
                        ..
                    },
                    ..
