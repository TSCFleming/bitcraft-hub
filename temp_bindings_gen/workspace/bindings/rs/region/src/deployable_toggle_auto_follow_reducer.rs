...
pub trait deployable_toggle_auto_follow {
    ...
    fn on_deployable_toggle_auto_follow(&self, callback: impl FnMut(&super::ReducerEventContext, &i32, ) + Send + 'static) -> DeployableToggleAutoFollowCallbackId;
    /// Cancel a callback previously registered by [`Self::on_deployable_toggle_auto_follow`],
    /// causing it not to run in the future.
    fn remove_on_deployable_toggle_auto_follow(&self, callback: DeployableToggleAutoFollowCallbackId);
}

impl deployable_toggle_auto_follow for super::RemoteReducers {
    fn deployable_toggle_auto_follow(&self, deployable_desc_id: i32,
) -> __sdk::Result<()> {
        self.imp.call_reducer("deployable_toggle_auto_follow", DeployableToggleAutoFollowArgs { deployable_desc_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::DeployableToggleAutoFollow {
                            deployable_desc_id, 
                        },
                        ..
                    },
    ...
    fn remove_on_deployable_toggle_auto_follow(&self, callback: DeployableToggleAutoFollowCallbackId) {
        self.imp.remove_on_reducer("deployable_toggle_auto_follow", callback.0)
    }
}
...
impl set_flags_for_deployable_toggle_auto_follow for super::SetReducerFlags {
    fn deployable_toggle_auto_follow(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("deployable_toggle_auto_follow", flags);
    }
}
