...
pub trait world_place_building {
    ...
    fn on_world_place_building(&self, callback: impl FnMut(&super::ReducerEventContext, &WorldPlaceBuildingRequest, ) + Send + 'static) -> WorldPlaceBuildingCallbackId;
...
impl world_place_building for super::RemoteReducers {
    fn world_place_building(&self, request: WorldPlaceBuildingRequest,
        ...
        self.imp.call_reducer("world_place_building", WorldPlaceBuildingArgs { request,  })
    }
    fn on_world_place_building(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &WorldPlaceBuildingRequest, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::WorldPlaceBuilding {
                            request, 
                        },
                        ..
                    },
    ...
    fn remove_on_world_place_building(&self, callback: WorldPlaceBuildingCallbackId) {
        self.imp.remove_on_reducer("world_place_building", callback.0)
    }
}
...
impl set_flags_for_world_place_building for super::SetReducerFlags {
    fn world_place_building(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("world_place_building", flags);
    }
}
