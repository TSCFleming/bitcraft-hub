...
tech_id: i32,
    ...
    fn on_cheat_claim_unlock_tech(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, &i32, ) + Send + 'static) -> CheatClaimUnlockTechCallbackId;
...
tech_id: i32,
        ...
        self.imp.call_reducer("cheat_claim_unlock_tech", CheatClaimUnlockTechArgs { claim_entity_id, tech_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::CheatClaimUnlockTech {
                            claim_entity_id, tech_id, 
                        },
                        ..
                    },
                    ..
    ...
    fn remove_on_cheat_claim_unlock_tech(&self, callback: CheatClaimUnlockTechCallbackId) {
        self.imp.remove_on_reducer("cheat_claim_unlock_tech", callback.0)
    }
}
...
impl set_flags_for_cheat_claim_unlock_tech for super::SetReducerFlags {
    fn cheat_claim_unlock_tech(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("cheat_claim_unlock_tech", flags);
    }
}
