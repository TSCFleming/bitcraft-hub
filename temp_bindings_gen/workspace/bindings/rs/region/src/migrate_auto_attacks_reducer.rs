...
pub trait migrate_auto_attacks {
    ...
    fn on_migrate_auto_attacks(&self, callback: impl FnMut(&super::ReducerEventContext, ) + Send + 'static) -> MigrateAutoAttacksCallbackId;
...
impl migrate_auto_attacks for super::RemoteReducers {
    fn migrate_auto_attacks(&self, ) -> __sdk::Result<()> {
        self.imp.call_reducer("migrate_auto_attacks", MigrateAutoAttacksArgs {  })
    }
    ...
    fn remove_on_migrate_auto_attacks(&self, callback: MigrateAutoAttacksCallbackId) {
        self.imp.remove_on_reducer("migrate_auto_attacks", callback.0)
    }
}
...
impl set_flags_for_migrate_auto_attacks for super::SetReducerFlags {
    fn migrate_auto_attacks(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("migrate_auto_attacks", flags);
    }
}
