...
moving_cost: i32,
    ...
    fn on_update_moving_cost(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, &i32, ) + Send + 'static) -> UpdateMovingCostCallbackId;
...
moving_cost: i32,
        ...
        self.imp.call_reducer("update_moving_cost", UpdateMovingCostArgs { player_housing_entity_id, moving_cost,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::UpdateMovingCost {
                            player_housing_entity_id, moving_cost, 
                        },
                        ..
                    },
                    ..
