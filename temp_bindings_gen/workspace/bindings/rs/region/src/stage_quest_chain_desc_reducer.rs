...
pub trait stage_quest_chain_desc {
    ...
    fn on_stage_quest_chain_desc(&self, callback: impl FnMut(&super::ReducerEventContext, &Vec::<QuestChainDesc>, ) + Send + 'static) -> StageQuestChainDescCallbackId;
...
impl stage_quest_chain_desc for super::RemoteReducers {
    fn stage_quest_chain_desc(&self, records: Vec::<QuestChainDesc>,
        ...
        self.imp.call_reducer("stage_quest_chain_desc", StageQuestChainDescArgs { records,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::StageQuestChainDesc {
                            records, 
                        },
                        ..
                    },
    ...
    fn remove_on_stage_quest_chain_desc(&self, callback: StageQuestChainDescCallbackId) {
        self.imp.remove_on_reducer("stage_quest_chain_desc", callback.0)
    }
}
...
impl set_flags_for_stage_quest_chain_desc for super::SetReducerFlags {
    fn stage_quest_chain_desc(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("stage_quest_chain_desc", flags);
    }
}
