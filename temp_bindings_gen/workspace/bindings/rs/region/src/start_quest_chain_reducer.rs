...
pub trait start_quest_chain {
    ...
    fn on_start_quest_chain(&self, callback: impl FnMut(&super::ReducerEventContext, &i32, ) + Send + 'static) -> StartQuestChainCallbackId;
...
impl start_quest_chain for super::RemoteReducers {
    fn start_quest_chain(&self, id: i32,
        ...
        self.imp.call_reducer("start_quest_chain", StartQuestChainArgs { id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::StartQuestChain {
                            id, 
                        },
                        ..
                    },
