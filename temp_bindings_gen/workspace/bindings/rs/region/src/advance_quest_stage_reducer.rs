...
pub trait advance_quest_stage {
    ...
    fn on_advance_quest_stage(&self, callback: impl FnMut(&super::ReducerEventContext, &i32, ) + Send + 'static) -> AdvanceQuestStageCallbackId;
...
impl advance_quest_stage for super::RemoteReducers {
    fn advance_quest_stage(&self, chain_id: i32,
        ...
        self.imp.call_reducer("advance_quest_stage", AdvanceQuestStageArgs { chain_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AdvanceQuestStage {
                            chain_id, 
                        },
                        ..
                    },
    ...
    fn remove_on_advance_quest_stage(&self, callback: AdvanceQuestStageCallbackId) {
        self.imp.remove_on_reducer("advance_quest_stage", callback.0)
    }
}
...
impl set_flags_for_advance_quest_stage for super::SetReducerFlags {
    fn advance_quest_stage(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("advance_quest_stage", flags);
    }
}
