...
timestamp: u64,
    ...
    fn on_prospect(&self, callback: impl FnMut(&super::ReducerEventContext, &i32, &u64, ) + Send + 'static) -> ProspectCallbackId;
...
timestamp: u64,
        ...
        self.imp.call_reducer("prospect", ProspectArgs { prospecting_id, timestamp,  })
    }
    fn on_prospect(
        &self,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::Prospect {
