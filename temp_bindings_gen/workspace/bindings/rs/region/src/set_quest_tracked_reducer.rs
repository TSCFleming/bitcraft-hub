...
tracked: bool,
    ...
    fn on_set_quest_tracked(&self, callback: impl FnMut(&super::ReducerEventContext, &i32, &bool, ) + Send + 'static) -> SetQuestTrackedCallbackId;
...
tracked: bool,
        ...
        self.imp.call_reducer("set_quest_tracked", SetQuestTrackedArgs { id, tracked,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::SetQuestTracked {
                            id, tracked, 
                        },
                        ..
                    },
