...
timestamp: u64,
    ...
    fn on_ability_custom_activate_start(&self, callback: impl FnMut(&super::ReducerEventContext, &i32, &u64, &u64, ) + Send + 'static) -> AbilityCustomActivateStartCallbackId;
    /// Cancel a callback previously registered by [`Self::on_ability_custom_activate_start`],
    /// causing it not to run in the future.
    fn remove_on_ability_custom_activate_start(&self, callback: AbilityCustomActivateStartCallbackId);
}
...
timestamp: u64,
        ...
        self.imp.call_reducer("ability_custom_activate_start", AbilityCustomActivateStartArgs { ability_custom_id, target_entity_id, timestamp,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AbilityCustomActivateStart {
                            ability_custom_id, target_entity_id, timestamp, 
                        },
                        ..
                    },
                    ..
    ...
    fn remove_on_ability_custom_activate_start(&self, callback: AbilityCustomActivateStartCallbackId) {
        self.imp.remove_on_reducer("ability_custom_activate_start", callback.0)
    }
}
...
impl set_flags_for_ability_custom_activate_start for super::SetReducerFlags {
    fn ability_custom_activate_start(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("ability_custom_activate_start", flags);
    }
}
