...
owner_entity_id: u64,
    ...
    fn on_cheat_drop_item_on_entity(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, &i32, &i32, &bool, &u64, ) + Send + 'static) -> CheatDropItemOnEntityCallbackId;
...
owner_entity_id: u64,
        ...
        self.imp.call_reducer("cheat_drop_item_on_entity", CheatDropItemOnEntityArgs { entity_id, item_id, quantity, is_cargo, owner_entity_id,  })
    }
    fn on_cheat_drop_item_on_entity(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &u64, &i32, &i32, &bool, &u64, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::CheatDropItemOnEntity {
                            entity_id, item_id, quantity, is_cargo, owner_entity_id, 
                        },
                        ..
                    },
                    ..
    ...
    fn remove_on_cheat_drop_item_on_entity(&self, callback: CheatDropItemOnEntityCallbackId) {
        self.imp.remove_on_reducer("cheat_drop_item_on_entity", callback.0)
    }
}
...
impl set_flags_for_cheat_drop_item_on_entity for super::SetReducerFlags {
    fn cheat_drop_item_on_entity(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("cheat_drop_item_on_entity", flags);
    }
}
