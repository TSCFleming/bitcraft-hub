...
expected_time_cost: i32,
    ...
    fn on_player_housing_change_entrance(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, &i32, ) + Send + 'static) -> PlayerHousingChangeEntranceCallbackId;
...
expected_time_cost: i32,
        ...
        self.imp.call_reducer("player_housing_change_entrance", PlayerHousingChangeEntranceArgs { building_entity_id, expected_time_cost,  })
    }
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::PlayerHousingChangeEntrance {
                            building_entity_id, expected_time_cost, 
                        },
                        ..
                    },
                    ..
