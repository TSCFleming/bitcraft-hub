...
world_target: i32,
    ...
    fn on_admin_set_resource_world_target(&self, callback: impl FnMut(&super::ReducerEventContext, &i32, &i32, ) + Send + 'static) -> AdminSetResourceWorldTargetCallbackId;
    /// Cancel a callback previously registered by [`Self::on_admin_set_resource_world_target`],
    /// causing it not to run in the future.
    fn remove_on_admin_set_resource_world_target(&self, callback: AdminSetResourceWorldTargetCallbackId);
}
...
world_target: i32,
        ...
        self.imp.call_reducer("admin_set_resource_world_target", AdminSetResourceWorldTargetArgs { resource_id, world_target,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AdminSetResourceWorldTarget {
                            resource_id, world_target, 
                        },
                        ..
                    },
                    ..
    ...
    fn remove_on_admin_set_resource_world_target(&self, callback: AdminSetResourceWorldTargetCallbackId) {
        self.imp.remove_on_reducer("admin_set_resource_world_target", callback.0)
    }
}
...
impl set_flags_for_admin_set_resource_world_target for super::SetReducerFlags {
    fn admin_set_resource_world_target(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("admin_set_resource_world_target", flags);
    }
}
