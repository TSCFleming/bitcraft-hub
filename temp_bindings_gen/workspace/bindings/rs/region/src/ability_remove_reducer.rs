...
local_ability_index: u8,
    ...
    fn on_ability_remove(&self, callback: impl FnMut(&super::ReducerEventContext, &u8, &u8, ) + Send + 'static) -> AbilityRemoveCallbackId;
...
local_ability_index: u8,
        ...
        self.imp.call_reducer("ability_remove", AbilityRemoveArgs { action_bar_index, local_ability_index,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AbilityRemove {
                            action_bar_index, local_ability_index, 
                        },
                        ..
                    },
                    ..
