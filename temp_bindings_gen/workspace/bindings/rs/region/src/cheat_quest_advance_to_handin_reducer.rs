...
quest_desc_id: i32,
    ...
    fn on_cheat_quest_advance_to_handin(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, &i32, ) + Send + 'static) -> CheatQuestAdvanceToHandinCallbackId;
    /// Cancel a callback previously registered by [`Self::on_cheat_quest_advance_to_handin`],
    /// causing it not to run in the future.
    fn remove_on_cheat_quest_advance_to_handin(&self, callback: CheatQuestAdvanceToHandinCallbackId);
}
...
quest_desc_id: i32,
        ...
        self.imp.call_reducer("cheat_quest_advance_to_handin", CheatQuestAdvanceToHandinArgs { player_entity_id, quest_desc_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::CheatQuestAdvanceToHandin {
                            player_entity_id, quest_desc_id, 
                        },
                        ..
                    },
                    ..
    ...
    fn remove_on_cheat_quest_advance_to_handin(&self, callback: CheatQuestAdvanceToHandinCallbackId) {
        self.imp.remove_on_reducer("cheat_quest_advance_to_handin", callback.0)
    }
}
...
impl set_flags_for_cheat_quest_advance_to_handin for super::SetReducerFlags {
    fn cheat_quest_advance_to_handin(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("cheat_quest_advance_to_handin", flags);
    }
}
