...
pub trait request_stage_reward {
    ...
    fn on_request_stage_reward(&self, callback: impl FnMut(&super::ReducerEventContext, &i32, ) + Send + 'static) -> RequestStageRewardCallbackId;
...
impl request_stage_reward for super::RemoteReducers {
    fn request_stage_reward(&self, reward_id: i32,
        ...
        self.imp.call_reducer("request_stage_reward", RequestStageRewardArgs { reward_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::RequestStageReward {
                            reward_id, 
                        },
                        ..
                    },
    ...
    fn remove_on_request_stage_reward(&self, callback: RequestStageRewardCallbackId) {
        self.imp.remove_on_reducer("request_stage_reward", callback.0)
    }
}
...
impl set_flags_for_request_stage_reward for super::SetReducerFlags {
    fn request_stage_reward(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("request_stage_reward", flags);
    }
}
