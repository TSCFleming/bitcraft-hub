...
grant_if_already_owned: bool,
    ...
    fn on_migration_set_achievement_params(&self, callback: impl FnMut(&super::ReducerEventContext, &bool, &bool, ) + Send + 'static) -> MigrationSetAchievementParamsCallbackId;
    /// Cancel a callback previously registered by [`Self::on_migration_set_achievement_params`],
    /// causing it not to run in the future.
    fn remove_on_migration_set_achievement_params(&self, callback: MigrationSetAchievementParamsCallbackId);
}
...
grant_if_already_owned: bool,
        ...
        self.imp.call_reducer("migration_set_achievement_params", MigrationSetAchievementParamsArgs { allow_destructive, grant_if_already_owned,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::MigrationSetAchievementParams {
                            allow_destructive, grant_if_already_owned, 
                        },
                        ..
                    },
                    ..
    ...
    fn remove_on_migration_set_achievement_params(&self, callback: MigrationSetAchievementParamsCallbackId) {
        self.imp.remove_on_reducer("migration_set_achievement_params", callback.0)
    }
}
...
impl set_flags_for_migration_set_achievement_params for super::SetReducerFlags {
    fn migration_set_achievement_params(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("migration_set_achievement_params", flags);
    }
}
