...
pub trait player_settings_state_update {
    ...
    fn on_player_settings_state_update(&self, callback: impl FnMut(&super::ReducerEventContext, &PlayerSettingsState, ) + Send + 'static) -> PlayerSettingsStateUpdateCallbackId;
...
impl player_settings_state_update for super::RemoteReducers {
    fn player_settings_state_update(&self, player_settings_state: PlayerSettingsState,
        ...
        self.imp.call_reducer("player_settings_state_update", PlayerSettingsStateUpdateArgs { player_settings_state,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::PlayerSettingsStateUpdate {
    ...
    fn remove_on_player_settings_state_update(&self, callback: PlayerSettingsStateUpdateCallbackId) {
        self.imp.remove_on_reducer("player_settings_state_update", callback.0)
    }
}
...
impl set_flags_for_player_settings_state_update for super::SetReducerFlags {
    fn player_settings_state_update(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("player_settings_state_update", flags);
    }
}
