...
pub trait world_place_resource {
    ...
    fn on_world_place_resource(&self, callback: impl FnMut(&super::ReducerEventContext, &WorldPlaceResourceRequest, ) + Send + 'static) -> WorldPlaceResourceCallbackId;
...
impl world_place_resource for super::RemoteReducers {
    fn world_place_resource(&self, request: WorldPlaceResourceRequest,
        ...
        self.imp.call_reducer("world_place_resource", WorldPlaceResourceArgs { request,  })
    }
    fn on_world_place_resource(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &WorldPlaceResourceRequest, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::WorldPlaceResource {
                            request, 
                        },
                        ..
                    },
    ...
    fn remove_on_world_place_resource(&self, callback: WorldPlaceResourceCallbackId) {
        self.imp.remove_on_reducer("world_place_resource", callback.0)
    }
}
...
impl set_flags_for_world_place_resource for super::SetReducerFlags {
    fn world_place_resource(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("world_place_resource", flags);
    }
}
