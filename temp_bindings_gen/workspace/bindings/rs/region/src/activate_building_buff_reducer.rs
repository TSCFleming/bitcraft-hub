...
pub trait activate_building_buff {
    ...
    fn on_activate_building_buff(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> ActivateBuildingBuffCallbackId;
...
impl activate_building_buff for super::RemoteReducers {
    fn activate_building_buff(&self, building_entity_id: u64,
        ...
        self.imp.call_reducer("activate_building_buff", ActivateBuildingBuffArgs { building_entity_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::ActivateBuildingBuff {
                            building_entity_id, 
                        },
                        ..
                    },
    ...
    fn remove_on_activate_building_buff(&self, callback: ActivateBuildingBuffCallbackId) {
        self.imp.remove_on_reducer("activate_building_buff", callback.0)
    }
}
...
impl set_flags_for_activate_building_buff for super::SetReducerFlags {
    fn activate_building_buff(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("activate_building_buff", flags);
    }
}
