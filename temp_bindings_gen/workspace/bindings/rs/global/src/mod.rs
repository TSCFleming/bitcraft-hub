...
pub use add_official_translator_reducer::{add_official_translator, set_flags_for_add_official_translator, AddOfficialTranslatorCallbackId};
pub use admin_add_or_update_flagged_word_reducer::{admin_add_or_update_flagged_word, set_flags_for_admin_add_or_update_flagged_word, AdminAddOrUpdateFlaggedWordCallbackId};
pub use admin_add_or_update_moderation_consequence_reducer::{admin_add_or_update_moderation_consequence, set_flags_for_admin_add_or_update_moderation_consequence, AdminAddOrUpdateModerationConsequenceCallbackId};
pub use admin_add_or_update_moderation_flag_level_threshold_reducer::{admin_add_or_update_moderation_flag_level_threshold, set_flags_for_admin_add_or_update_moderation_flag_level_threshold, AdminAddOrUpdateModerationFlagLevelThresholdCallbackId};
pub use admin_add_or_update_moderation_threshold_reducer::{admin_add_or_update_moderation_threshold, set_flags_for_admin_add_or_update_moderation_threshold, AdminAddOrUpdateModerationThresholdCallbackId};
pub use admin_add_or_update_moderation_violation_reducer::{admin_add_or_update_moderation_violation, set_flags_for_admin_add_or_update_moderation_violation, AdminAddOrUpdateModerationViolationCallbackId};
pub use admin_add_or_update_replacement_text_reducer::{admin_add_or_update_replacement_text, set_flags_for_admin_add_or_update_replacement_text, AdminAddOrUpdateReplacementTextCallbackId};
pub use admin_add_or_update_word_replacement_reducer::{admin_add_or_update_word_replacement, set_flags_for_admin_add_or_update_word_replacement, AdminAddOrUpdateWordReplacementCallbackId};
pub use admin_add_player_previous_name_reducer::{admin_add_player_previous_name, set_flags_for_admin_add_player_previous_name, AdminAddPlayerPreviousNameCallbackId};
pub use admin_assign_empire_chunks_reducer::{admin_assign_empire_chunks, set_flags_for_admin_assign_empire_chunks, AdminAssignEmpireChunksCallbackId};
pub use admin_broadcast_msg_reducer::{admin_broadcast_msg, set_flags_for_admin_broadcast_msg, AdminBroadcastMsgCallbackId};
pub use admin_change_empire_emblem_reducer::{admin_change_empire_emblem, set_flags_for_admin_change_empire_emblem, AdminChangeEmpireEmblemCallbackId};
...
pub use admin_mark_premium_purchase_processed_reducer::{admin_mark_premium_purchase_processed, set_flags_for_admin_mark_premium_purchase_processed, AdminMarkPremiumPurchaseProcessedCallbackId};
...
pub use admin_populate_empire_names_reducer::{admin_populate_empire_names, set_flags_for_admin_populate_empire_names, AdminPopulateEmpireNamesCallbackId};
pub use admin_populate_player_skills_reducer::{admin_populate_player_skills, set_flags_for_admin_populate_player_skills, AdminPopulatePlayerSkillsCallbackId};
...
pub use admin_remove_flagged_word_reducer::{admin_remove_flagged_word, set_flags_for_admin_remove_flagged_word, AdminRemoveFlaggedWordCallbackId};
pub use admin_remove_moderation_consequence_reducer::{admin_remove_moderation_consequence, set_flags_for_admin_remove_moderation_consequence, AdminRemoveModerationConsequenceCallbackId};
pub use admin_remove_moderation_flag_level_threshold_reducer::{admin_remove_moderation_flag_level_threshold, set_flags_for_admin_remove_moderation_flag_level_threshold, AdminRemoveModerationFlagLevelThresholdCallbackId};
pub use admin_remove_moderation_threshold_reducer::{admin_remove_moderation_threshold, set_flags_for_admin_remove_moderation_threshold, AdminRemoveModerationThresholdCallbackId};
pub use admin_remove_moderation_violation_reducer::{admin_remove_moderation_violation, set_flags_for_admin_remove_moderation_violation, AdminRemoveModerationViolationCallbackId};
pub use admin_remove_player_previous_name_reducer::{admin_remove_player_previous_name, set_flags_for_admin_remove_player_previous_name, AdminRemovePlayerPreviousNameCallbackId};
pub use admin_remove_replacement_text_reducer::{admin_remove_replacement_text, set_flags_for_admin_remove_replacement_text, AdminRemoveReplacementTextCallbackId};
pub use admin_remove_word_replacement_reducer::{admin_remove_word_replacement, set_flags_for_admin_remove_word_replacement, AdminRemoveWordReplacementCallbackId};
...
pub use admin_replace_identity_reducer::{admin_replace_identity, set_flags_for_admin_replace_identity, AdminReplaceIdentityCallbackId};
...
pub use admin_unassign_empire_chunks_reducer::{admin_unassign_empire_chunks, set_flags_for_admin_unassign_empire_chunks, AdminUnassignEmpireChunksCallbackId};
...
pub use admin_update_moderation_enforcement_config_reducer::{admin_update_moderation_enforcement_config, set_flags_for_admin_update_moderation_enforcement_config, AdminUpdateModerationEnforcementConfigCallbackId};
pub use admin_update_report_moderation_config_reducer::{admin_update_report_moderation_config, set_flags_for_admin_update_report_moderation_config, AdminUpdateReportModerationConfigCallbackId};
...
pub use ban_player_from_chat_channel_reducer::{ban_player_from_chat_channel, set_flags_for_ban_player_from_chat_channel, BanPlayerFromChatChannelCallbackId};
...
pub use chat_post_targeted_message_reducer::{chat_post_targeted_message, set_flags_for_chat_post_targeted_message, ChatPostTargetedMessageCallbackId};
...
pub use correct_translation_reducer::{correct_translation, set_flags_for_correct_translation, CorrectTranslationCallbackId};
pub use create_chat_channel_reducer::{create_chat_channel, set_flags_for_create_chat_channel, CreateChatChannelCallbackId};
...
pub use edit_chat_channel_reducer::{edit_chat_channel, set_flags_for_edit_chat_channel, EditChatChannelCallbackId};
pub use edit_chat_channel_member_permission_reducer::{edit_chat_channel_member_permission, set_flags_for_edit_chat_channel_member_permission, EditChatChannelMemberPermissionCallbackId};
...
pub use invite_to_chat_channel_reducer::{invite_to_chat_channel, set_flags_for_invite_to_chat_channel, InviteToChatChannelCallbackId};
pub use join_chat_channel_reducer::{join_chat_channel, set_flags_for_join_chat_channel, JoinChatChannelCallbackId};
pub use leave_chat_channel_reducer::{leave_chat_channel, set_flags_for_leave_chat_channel, LeaveChatChannelCallbackId};
...
pub use player_restore_skills_reducer::{player_restore_skills, set_flags_for_player_restore_skills, PlayerRestoreSkillsCallbackId};
...
pub use purchase_character_rename_reducer::{purchase_character_rename, set_flags_for_purchase_character_rename, PurchaseCharacterRenameCallbackId};
pub use purchase_premium_item_reducer::{purchase_premium_item, set_flags_for_purchase_premium_item, PurchasePremiumItemCallbackId};
pub use remove_chat_channel_reducer::{remove_chat_channel, set_flags_for_remove_chat_channel, RemoveChatChannelCallbackId};
pub use remove_chat_channel_member_reducer::{remove_chat_channel_member, set_flags_for_remove_chat_channel_member, RemoveChatChannelMemberCallbackId};
...
pub use report_targeted_chat_message_reducer::{report_targeted_chat_message, set_flags_for_report_targeted_chat_message, ReportTargetedChatMessageCallbackId};
...
pub use unban_player_from_chat_channel_reducer::{unban_player_from_chat_channel, set_flags_for_unban_player_from_chat_channel, UnbanPlayerFromChatChannelCallbackId};
...
pub use world_clear_npc_empire_reducer::{world_clear_npc_empire, set_flags_for_world_clear_npc_empire, WorldClearNpcEmpireCallbackId};
pub use world_form_npc_empire_reducer::{world_form_npc_empire, set_flags_for_world_form_npc_empire, WorldFormNpcEmpireCallbackId};
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(&self, cache: &mut __sdk::ClientCache<RemoteModule>) -> AppliedDiff<'_> {
        ...
        diff.mod_consequence_state = cache.apply_diff_to_table::<ModConsequenceState>("mod_consequence_state", &self.mod_consequence_state).with_updates_by_pk(|row| &row.id);
        diff.mod_enforcement_config_state = cache.apply_diff_to_table::<ModEnforcementConfigState>("mod_enforcement_config_state", &self.mod_enforcement_config_state).with_updates_by_pk(|row| &row.id);
        diff.mod_flag_level_threshold_state = cache.apply_diff_to_table::<ModFlagLevelThresholdState>("mod_flag_level_threshold_state", &self.mod_flag_level_threshold_state).with_updates_by_pk(|row| &row.flag_level);
        diff.mod_flagged_word_state = cache.apply_diff_to_table::<ModFlaggedWordState>("mod_flagged_word_state", &self.mod_flagged_word_state).with_updates_by_pk(|row| &row.id);
        diff.mod_replacement_text_state = cache.apply_diff_to_table::<ModReplacementTextState>("mod_replacement_text_state", &self.mod_replacement_text_state).with_updates_by_pk(|row| &row.text_type);
        diff.mod_report_config_state = cache.apply_diff_to_table::<ModReportConfigState>("mod_report_config_state", &self.mod_report_config_state).with_updates_by_pk(|row| &row.id);
        diff.mod_threshold_state = cache.apply_diff_to_table::<ModThresholdState>("mod_threshold_state", &self.mod_threshold_state).with_updates_by_pk(|row| &row.id);
        diff.mod_violation_state = cache.apply_diff_to_table::<ModViolationState>("mod_violation_state", &self.mod_violation_state).with_updates_by_pk(|row| &row.violation_type);
        diff.mod_word_replacement_state = cache.apply_diff_to_table::<ModWordReplacementState>("mod_word_replacement_state", &self.mod_word_replacement_state).with_updates_by_pk(|row| &row.id);
        ...
        diff.user_creation_timestamp_state = cache.apply_diff_to_table::<UserCreationTimestampState>("user_creation_timestamp_state", &self.user_creation_timestamp_state).with_updates_by_pk(|row| &row.identity);
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(&self, event: &EventContext, callbacks: &mut __sdk::DbCallbacks<RemoteModule>) {
        ...
        callbacks.invoke_table_row_callbacks::<ModConsequenceState>("mod_consequence_state", &self.mod_consequence_state, event);
        callbacks.invoke_table_row_callbacks::<ModEnforcementConfigState>("mod_enforcement_config_state", &self.mod_enforcement_config_state, event);
        callbacks.invoke_table_row_callbacks::<ModFlagLevelThresholdState>("mod_flag_level_threshold_state", &self.mod_flag_level_threshold_state, event);
        callbacks.invoke_table_row_callbacks::<ModFlaggedWordState>("mod_flagged_word_state", &self.mod_flagged_word_state, event);
        callbacks.invoke_table_row_callbacks::<ModReplacementTextState>("mod_replacement_text_state", &self.mod_replacement_text_state, event);
        callbacks.invoke_table_row_callbacks::<ModReportConfigState>("mod_report_config_state", &self.mod_report_config_state, event);
        callbacks.invoke_table_row_callbacks::<ModThresholdState>("mod_threshold_state", &self.mod_threshold_state, event);
        callbacks.invoke_table_row_callbacks::<ModViolationState>("mod_violation_state", &self.mod_violation_state, event);
        callbacks.invoke_table_row_callbacks::<ModWordReplacementState>("mod_word_replacement_state", &self.mod_word_replacement_state, event);
        ...
        callbacks.invoke_table_row_callbacks::<UserCreationTimestampState>("user_creation_timestamp_state", &self.user_creation_timestamp_state, event);
