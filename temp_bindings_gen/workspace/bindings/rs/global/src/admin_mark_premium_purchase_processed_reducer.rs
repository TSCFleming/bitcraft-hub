...
pub trait admin_mark_premium_purchase_processed {
    ...
    fn on_admin_mark_premium_purchase_processed(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> AdminMarkPremiumPurchaseProcessedCallbackId;
    /// Cancel a callback previously registered by [`Self::on_admin_mark_premium_purchase_processed`],
    /// causing it not to run in the future.
    fn remove_on_admin_mark_premium_purchase_processed(&self, callback: AdminMarkPremiumPurchaseProcessedCallbackId);
}

impl admin_mark_premium_purchase_processed for super::RemoteReducers {
    fn admin_mark_premium_purchase_processed(&self, entity_id: u64,
) -> __sdk::Result<()> {
        self.imp.call_reducer("admin_mark_premium_purchase_processed", AdminMarkPremiumPurchaseProcessedArgs { entity_id,  })
    }
    fn on_admin_mark_premium_purchase_processed(
        ...
        AdminMarkPremiumPurchaseProcessedCallbackId(self.imp.on_reducer(
            "admin_mark_premium_purchase_processed",
            Box::new(move |ctx: &super::ReducerEventContext| {
                #[allow(irrefutable_let_patterns)]
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AdminMarkPremiumPurchaseProcessed {
                            entity_id, 
                        },
                        ..
                    },
    ...
    fn remove_on_admin_mark_premium_purchase_processed(&self, callback: AdminMarkPremiumPurchaseProcessedCallbackId) {
        self.imp.remove_on_reducer("admin_mark_premium_purchase_processed", callback.0)
    }
}
...
impl set_flags_for_admin_mark_premium_purchase_processed for super::SetReducerFlags {
    fn admin_mark_premium_purchase_processed(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("admin_mark_premium_purchase_processed", flags);
    }
}
