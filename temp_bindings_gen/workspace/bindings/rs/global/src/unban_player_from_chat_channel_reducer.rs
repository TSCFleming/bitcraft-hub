...
player_entity_id: u64,
    ...
    fn on_unban_player_from_chat_channel(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, &u64, ) + Send + 'static) -> UnbanPlayerFromChatChannelCallbackId;
    /// Cancel a callback previously registered by [`Self::on_unban_player_from_chat_channel`],
    /// causing it not to run in the future.
    fn remove_on_unban_player_from_chat_channel(&self, callback: UnbanPlayerFromChatChannelCallbackId);
}
...
player_entity_id: u64,
        ...
        self.imp.call_reducer("unban_player_from_chat_channel", UnbanPlayerFromChatChannelArgs { channel_entity_id, player_entity_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::UnbanPlayerFromChatChannel {
    ...
    fn remove_on_unban_player_from_chat_channel(&self, callback: UnbanPlayerFromChatChannelCallbackId) {
        self.imp.remove_on_reducer("unban_player_from_chat_channel", callback.0)
    }
}
...
impl set_flags_for_unban_player_from_chat_channel for super::SetReducerFlags {
    fn unban_player_from_chat_channel(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("unban_player_from_chat_channel", flags);
    }
}
