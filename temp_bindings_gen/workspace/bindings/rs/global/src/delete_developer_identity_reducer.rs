...
pub trait delete_developer_identity {
    ...
    fn on_delete_developer_identity(&self, callback: impl FnMut(&super::ReducerEventContext, &String, ) + Send + 'static) -> DeleteDeveloperIdentityCallbackId;
...
impl delete_developer_identity for super::RemoteReducers {
    fn delete_developer_identity(&self, identity: String,
        ...
        self.imp.call_reducer("delete_developer_identity", DeleteDeveloperIdentityArgs { identity,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::DeleteDeveloperIdentity {
                            identity, 
                        },
                        ..
                    },
    ...
    fn remove_on_delete_developer_identity(&self, callback: DeleteDeveloperIdentityCallbackId) {
        self.imp.remove_on_reducer("delete_developer_identity", callback.0)
    }
}
...
impl set_flags_for_delete_developer_identity for super::SetReducerFlags {
    fn delete_developer_identity(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("delete_developer_identity", flags);
    }
}
