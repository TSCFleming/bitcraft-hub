...
region_count: u8,
    ...
    fn on_init_region_info(&self, callback: impl FnMut(&super::ReducerEventContext, &i32, &i32, &u8, &u8, ) + Send + 'static) -> InitRegionInfoCallbackId;
...
region_count: u8,
        ...
        self.imp.call_reducer("init_region_info", InitRegionInfoArgs { world_width, world_height, region_index, region_count,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::InitRegionInfo {
